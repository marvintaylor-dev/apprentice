...
module.exports.restrictedUserProfile = async (req, res) => {
  ...
  return res.render("restricted/profile", {
    user,
    fields,
    states,
    tiers,
...
module.exports.updateUserProfile = async (req, res, next) => {
  try {
    ...
    try {
      ...
      if (req.body.deleteImage) {
        ...
        await user.updateOne({
          $unset: { avatar: { filename: req.body.deleteImage } },
        });
      }
    ...
    req.flash(
      "error",
      "Could not update. Your profile entry was missing something."
    );
...
module.exports.mentorDashboard = async (req, res) => {
  ...
  return res.render("restricted/dashboard", {
    user,
    id,
    mentees,
    notes,
